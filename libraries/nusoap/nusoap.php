	...
	*/
	function invoke_method() {
		...
		if (!function_exists('call_user_func_array')) {
			...
			//var_dump($call_arg, $this->methodparams);
	...
	function serialize_return() {
		...
		if ($this->wsdl) {
			...
			if ($this->opData['style'] == 'rpc') {
				...
				switch ($this->opData["name"]) {
					case 'TicketCreado':
					case 'CortarLlamada':
					case 'CrearLlamada':
					case 'DarURL':
						$payload = '<ns1:'.$this->methodname.'Response xmlns:ns1="'.$this->methodURI.'">'.str_replace('parameters', 'response', $return_val).'</ns1:'.$this->methodname."Response>";
						break;
...
//				}
				...
				if( array_values( $this->soapresponse )[0] == "placeholder" ){
					
					$this->soapresponse[ array_key_first( $this->soapresponse ) ] = $this->multirefs[ array_key_first( $this->multirefs ) ];
				}
