{strip}
	<script src="{vresource_url('layouts/v7/modules/LPTempCampos/resources/FlowImport.js')}"></script>
	<div class='fc-overlay-modal modal-content'>
		...
		<div class="importview-content">
			...
			<div class='modal-body' style="display: none;"  id ="importContainerJson">
				...
				{include file='import/ImportPreview.tpl'|@vtemplate_path:'LPTempCampos'}
			</div>
