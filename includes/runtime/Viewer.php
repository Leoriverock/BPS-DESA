...
// LuderePro Custom Loader
include_once('includes/LudereProLoader.php');
LudereProLoader::LPReplaceMethod('Vtiger_Viewer','getTemplatePath');
LudereProLoader::LPReplaceMethod('Vtiger_Viewer','LPGetTemplatePath');