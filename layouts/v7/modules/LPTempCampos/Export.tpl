				...
				<div class="datacontent row">
					...
					<div class="col-lg-6">
						<div class="well exportContents">
							...
							<div style="margin-left: 50px;">
								<div>
									<input type="radio" name="mode" value="ExportCustomFlows" id="group5" style="margin:2px 0 -4px" />
									<label style="font-weight:normal" for="group5">&nbsp;&nbsp;{vtranslate('Exportar seleccionados como JSON',$MODULE)}</label>
								</div>
								<br>
								<div>
