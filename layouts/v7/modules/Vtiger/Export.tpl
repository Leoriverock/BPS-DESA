					...
					<div class="col-lg-6">
						<div class="well exportContents">
							...
							<div style="margin-left: 50px;">
								...
								<br>
								<div>
									<input type="radio" name="mode" value="ExportCurrentPage" id="group2" {if empty($SELECTED_IDS)}checked="checked" {/if}  style="margin:2px 0 -4px" />
								...
								<br>
								<div>
									<input type="radio" name="mode" value="ExportFilterWithParams" id="group5" style="margin:2px 0 -4px" />
									<label style="font-weight:normal" for="group5">&nbsp;&nbsp;{vtranslate('LBL_EXPORT_FILTER_DATA_WITH_PARAMS',$MODULE)}</label>
								</div>
								<br>
								<div>
									<table>
