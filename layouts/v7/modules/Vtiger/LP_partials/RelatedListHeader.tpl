                        ...
                        <div class="btn-group">
                            ...
                            {else}
                                ...
                                {if $IS_SELECT_BUTTON || $IS_CREATE_PERMITTED}
                                    {if $MODULE eq 'Accounts' AND $RELATED_MODULE_NAME eq 'HelpDesk'}
                                        <a type="button" 
                                            module="{$RELATED_MODULE_NAME}" 
                                            class="btn btn-default"
                                            href="{$RELATED_LINK->get('linkurl')}"
                                        >
                                            {if $IS_SELECT_BUTTON eq false}<i class="fa fa-plus"></i>&nbsp;{/if}&nbsp;{$RELATED_LINK->getLabel()}
                                        </a>
                                    {else}
