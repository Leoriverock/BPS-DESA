	...
	*/
	...
	saveComment : function(e) {
		...
		if(commentMode == "edit"){
			...
			postData['parent_comments'] = typeof commentId !== 'undefined' ? commentId : 0;
			postData['customer'] = 0;
	...
	registerBasicEvents: function(){
		var self = this;
		self.waitForElm('#rollupcomments').then((elm) => {
			self.onLoadPage = true;
			jQuery('#rollupcomments').click();
		});
