{strip}
    ...
    <!-- LP js/css que interesan esten disponibles siempre que el usuario este logueado -->
    {assign var=CURRENT_USER_MODEL value=Users_Record_Model::getCurrentUserModel()}
    {if $CURRENT_USER_MODEL->get('id')}
        <script type="text/javascript" src="libraries/luderepro/lpcalls.js"></script>
        <script type="text/javascript" src="libraries/luderepro/lpAttes.js"></script>
        <link rel="stylesheet" type="text/css" href="libraries/luderepro/lpcalls.css">
    </style>
    {/if}
