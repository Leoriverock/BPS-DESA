...
{strip}
    ...
    {*var_dump($CURRENT_USER_MODEL)*}
    {assign var=tienePermiso value=$CURRENT_USER_MODEL->tienePermiso()}
    {*var_dump($tienePermiso)*}
    <div id="listview-actions" class="listview-actions-container">
        ...
        <div class = "row">
            ...
            {if $tienePermiso}
                <input type="button" id="siguiente" class="btn btn-success" 
                            onclick="AtencionesWeb_List_Js.cargarModal()" value="Siguiente Consulta" >
            {/if}
...
<script type="text/javascript">
    $( document ).ready(function() {
        ...
        //Control de clic para que no se rompa la pantalla
