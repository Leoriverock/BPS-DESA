...
<div class="referencefield-wrapper {if $FIELD_VALUE neq 0} selected {/if}">
    ...
    <div class="input-group">
        ...
        <a href="#" class="clearReferenceSelection {if $FIELD_VALUE eq 0 || $ES_READONLY}hide{/if}"> x </a>
            ...
            <span class="input-group-addon {if in_array('Accounts', $REFERENCE_LIST)}customRelatedPopup{else}relatedPopup{/if} cursorPointer {if $ES_READONLY}hide{/if}" title="{vtranslate('LBL_SELECT', $MODULE)}">
