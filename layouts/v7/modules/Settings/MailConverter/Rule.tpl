	...
	<div class="mailConverterRuleBlock">
		<div class="details border1px">
			...
			<fieldset class="marginTop10px">
				...
				{/foreach}
				{assign var=ASSIGNED_TO_RULES_ARRAY value=array('CREATE_HelpDesk_FROM', 'CREATE_Leads_SUBJECT', 'CREATE_Contacts_SUBJECT', 'CREATE_Accounts_SUBJECT', 'CREATE_ConsultasWeb', 'CREATE_ConsultasWeb_FROM')}
