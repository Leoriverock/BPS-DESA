			...
			<div class="detailViewInfo" >
				<form id="detailView" class="form-horizontal" method="POST">
					...
					<div class="form-group">
						...
						<div class="fieldValue">
							{assign var=DisplayType value=explode(' |##| ',$RECORD_MODEL->getType())}
							<ul class="col-lg-6 col-md-6 col-sm-6 nav">
								{foreach item=type from=$DisplayType}
								<li>{vtranslate($type, $QUALIFIED_MODULE)}</li>
								{/foreach}
							</ul>
						</div>
					</div>
