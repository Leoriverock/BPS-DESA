					...
					<div class="editViewBody">
						...
						<div class="form-group row">
							...
							<div class="fieldValue col-lg-9 col-md-9 col-sm-9">
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">
										{assign var=typesSelected value=explode(' |##| ',$RECORD_MODEL->getType())}
										<input type="hidden" name="type"/>
										<select class="inputElement select2" multiple='true' name="typeSelect" id="type" >
											<option value="mail" {if in_array('mail', $typesSelected)}selected='true'{/if}>Mail</option>
											<option value="llamadas" {if in_array('llamadas', $typesSelected)}selected='true'{/if}>Llamadas</option>
											<option value="otros" {if in_array('otros', $typesSelected)}selected='true'{/if}>Otros</option>
										</select> 
									</div>
								</div>
							</div>
