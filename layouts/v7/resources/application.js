...
window.app = (function () {
	...
	return {
		...
		getModuleSpecificViewClass: function (view, module, parentModule) {
			...
			var handlerClass = "LuderePro_"+module+'_'+view+'_Js';
			if (typeof window[handlerClass] == 'undefined') {
				handlerClass = module+'_'+view+'_Js';
			}
			if (parentModule == 'Settings') {
				handlerClass = "LuderePro_"+parentModule+'_'+module+'_'+view+'_Js';
				if (typeof window[handlerClass] == 'undefined') {
					handlerClass = parentModule+'_'+module+'_'+view+'_Js';
				}
				if (typeof window[handlerClass] == 'undefined') {
					handlerClass = "LuderePro_"+parentModule+'_Vtiger_'+view+'_Js';
				}
				if (typeof window[handlerClass] == 'undefined') {
			...
			if (typeof window[handlerClass] != 'undefined') {
				...
				handlerClass = 'LuderePro_Vtiger_'+view+'_Js';
				if (typeof window[handlerClass] != 'undefined') {
					controllerClass = handlerClass;
				} else {
