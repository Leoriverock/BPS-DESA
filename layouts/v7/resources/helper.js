...
jQuery.Class("Vtiger_Helper_Js",{
    ...
    showModal2 : function(content,params) {
        ...
        var cb = params.cb;
        var container_doc = jQuery('.myModal2');
        console.log(container_doc);
        container_doc.on('hidden.bs.modal2',function() {
            container_doc.html('');
            ...
            if(jQuery('.myModal2').hasClass('in')){
                ...
                jQuery('.myModal').find('#cerrar').trigger('click');
                setTimeout(() => {
                    if(typeof AtencionesWeb_List_Js === 'function'){
                        AtencionesWeb_List_Js.cargarModal();
                    }
                    if(typeof ConsultasWeb_Detail_Js === 'function'){
                        ConsultasWeb_Detail_Js.cargarModal();
                    }
        ...
        if(typeof cb === "function") {
            container_doc.off('shown.bs.modal');
            //This event is fired when the modal has been made visible to the user
            container_doc.one('shown.bs.modal', function () {
                cb(container_doc);
            });
        }

        container_doc.html(content).modal(params);
        //vtUtils.applyFieldElementsView(container_doc);
    ...
    */ 
    ...
    hidePopup : function() {
        ...
        jQuery('#popupModal').removeAttr('tabindex');
    },
