...
class AtencionesWeb_Module_Model extends Vtiger_Module_Model {
    ...
    public function getModuleIcon($viewname = null) {
        ...
        if (file_exists($imageFilePath)) {
            ...
            if ($viewname == 'related') {
                $style = 'width:26px; filter: hue-rotate(0deg) saturate(0) brightness(0.60);\' class=\''.$moduleName.'RelTab';
            }
