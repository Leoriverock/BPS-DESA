...
class ConsultasWeb_List_View extends Vtiger_Index_View {
	...
	public function getRecordActionsFromModule($moduleModel) {
        global $log;
        $log->info("en getRecordActionsFromModule ");
		...
		$log->info("el permido para editar en el if es $editPermission");
		$recordActions = array();
