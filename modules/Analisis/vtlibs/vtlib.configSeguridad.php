...
/*
    ...
    Es muy importante añadir en el Module.php del Modulo:
...
$nombreModulo = 'Analisis';

$accesosA = array('UsuariosActivos','sumatoriActividades','DetallesTotxActividad', 'DetalleActivxEjec','DetalleActivxGrupo', 'InformeEspecial', 'MonitoreoNotif', 'Segmentador', 'VistaRapPolizas', 'GraficasActividades');
