...
abstract class Vtiger_Basic_View extends Vtiger_Footer_View {
	...
	function preProcess (Vtiger_Request $request, $display=true) {
		...
		//para mostrar si hay llamada activa 📞
		$viewer->assign('ACTIVE_CALL', Calls_Module_Model::getLlamadaActiva());
		$viewer->assign('ACTIVE_ATTE', AtencionPresencial_Module_Model::getAtencionpPActiva());//Leo
