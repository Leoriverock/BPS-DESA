...
class Settings_MailConverter_RuleField_Model extends Vtiger_Field_Model {
	...
	public function getPickListValues() {
        ...
        if($fieldName == 'subject') {
			...
			$optionList = array('CREATE_HelpDesk_FROM', 'UPDATE_HelpDesk_SUBJECT', 'CREATE_Leads_SUBJECT', 'CREATE_Contacts_SUBJECT', 'CREATE_Accounts_SUBJECT', 'LINK_Contacts_FROM', 'LINK_Contacts_TO', 'LINK_Leads_FROM', 'LINK_Leads_TO', 'LINK_Accounts_FROM', 'LINK_Accounts_TO', 'CREATE_ConsultasWeb_FROM');
			foreach ($optionList as $option) {
				$pickListValues[$option] = vtranslate($option, 'Settings::MailConverter');
            }
		}
