...
class AtencionPresencial_enCola_Action extends Vtiger_Action_Controller {
    ...
    public function process(Vtiger_Request $request) {
        ...
        if($actualizar){
            $recordModel = Vtiger_Record_Model::getInstanceById($recordId, $moduleName);
            $recordModel->set('ap_estado', 'Liberado');
        ...
        $response->setResult(array('success' => true, 'status' => $recordModel->get('ap_estado')));
        $response->emit();      
    }
}
?>